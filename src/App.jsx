  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="workspace-switcher"><span className="workspace-dot"></span><span><strong>Acme workspace</strong><small>Business account</small></span><span className="chevron">⌄</span></div>
      ...
      <main className="main-content">
        ...
        <div className="page-wrap">
          <section className="page-heading"><div><p className="eyebrow">Wednesday, August 22, 2024</p><h1>Good morning, Jordan <span>✦</span></h1><p className="subheading">Here is what is happening across your business today.</p></div><button className="primary-button" onClick={() => setShowForm(true)}><span>+</span> Add transaction</button></section>
